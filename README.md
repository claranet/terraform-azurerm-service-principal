...
| single\_page\_application\_settings | Configuration for single page application related settings for this Service Principal. | <pre>object({<br/>    redirect_uris = optional(list(string), [])<br/>  })</pre> | `{}` | no |
